...
function activeLink() {
    navLinks.forEach(item => item.classList.remove('active')); // Remova a classe "active" de todos os links
...
if (savedTheme) {
  document.documentElement.classList.toggle('light', savdTheme === 'light');
}